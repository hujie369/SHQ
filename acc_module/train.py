...
if __name__ == "__main__":
    ...
    parser.add_argument('-verbose', help='print some result or not', type=bool, default=False)
    ...
    for epoch in range(max_epoch):
        ...
        if epoch % num_val == 0:
            ...
            vallossdata.append(val)
            if val < best:
                best = val

                torch.save({'model':model.state_dict()}, f'./output/{args.model+args.data}.pth')
            # vallossdata.append(float(validation(True))**0.5)
